...
- [x] `SSH_TARGET_DIR` = `/var/www/life-hacks/`
...
## 6) Verify Live Site
- [x] Check directory on server: `ls -la /var/www/life-hacks | head`
- [x] Browse: `https://saleem.net/life-hacks/`
- [x] Spot-check links and assets load correctly

## 7) Mirror Notion Content (initial manual step)
- [x] Export or copy content from Notion: `http://notion.saleem.net/life-hacks`
...
- [x] Create `/var/www/life-hacks-test/` and add a temp location `^~ /life-hacks-test/`
- [x] Point `SSH_TARGET_DIR` to test path for first deploy
- [x] Verify, then switch back to `/life-hacks/`
